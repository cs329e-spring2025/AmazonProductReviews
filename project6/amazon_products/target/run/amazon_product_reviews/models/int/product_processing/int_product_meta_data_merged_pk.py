...
def ref(*args, **kwargs):
    refs = {"int_product_meta_data_merged": "amazon-product-reviews-452322.jaffle_shop.int_product_meta_data_merged"}
    key = '.'.join(args)
...
class this:
    ...
    schema = "jaffle_shop"
    identifier = "int_product_meta_data_merged_pk"
    
    def __repr__(self):
        return 'amazon-product-reviews-452322.jaffle_shop.int_product_meta_data_merged_pk'
...
df.write \
  ...
  .save("amazon-product-reviews-452322.jaffle_shop.int_product_meta_data_merged_pk")
