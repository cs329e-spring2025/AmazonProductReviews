    ...
    create or replace table `amazon-product-reviews-452322`.`jaffle_shop`.`int_product_meta_data_transformed`
...
FROM `amazon-product-reviews-452322`.`jaffle_shop`.`int_product_meta_data_cleaned`
    );
